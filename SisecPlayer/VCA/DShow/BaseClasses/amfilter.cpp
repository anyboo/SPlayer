...
)
{
	...
	ALLOCATOR_PROPERTIES *pProp = (ALLOCATOR_PROPERTIES*) pbProperties;

	TCHAR bufErr[255];
	
	_stprintf_s(bufErr, _countof(bufErr),
		_T("CMediaSample::SetProperties cbPro:%d \n align:%d cbBuf:%d cbPrefix:%d cBuf:%d\n"),
