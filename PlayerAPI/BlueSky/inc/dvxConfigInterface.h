...
#ifndef __DVX_CONFIG_INTERFACE_H__
#define __DVX_CONFIG_INTERFACE_H__
...
DVXSDKCONFIG_API int dvxConfig( DvxHandle hDvr, const char* szUser, const char* szAddr, LONG nLangID, int nFlag=0, BOOL bOnlyPlay = FALSE, unsigned __int64  npurview = 1 );

#endif	// end of __DVX_CONFIG_INTERFACE_H__
